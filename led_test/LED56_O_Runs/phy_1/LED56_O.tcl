...
set rc [catch {
  open_project {LED56_O.prj}
  import_device eagle_s20.db -package EG4S20BG256
  import_db {../syn_1/LED56_O_gate.db}
  place
  export_db {LED56_O_place.db}
} RESULT]
if {$rc} {
...
set rc [catch {
  route
  report_area -io_info -file LED56_O_phy.area
  export_db {LED56_O_pr.db}
} RESULT]
if {$rc} {
...
set rc [catch {
  export_bid LED56_O_inst.bid
  bitgen -bit "LED56_O.bit"
} RESULT]
if {$rc} {
  step_error bitgen
  return -code error $RESULT
